...
def print_state():
   ...
   print "pkts_sent: {0}\tnormal_recv: {1}\trecirc_recv: {2}\tother_recv: {3}".format(num_pkts_sent, num_normal_pkts_recv, num_recirc_pkts_recv, num_other_pkts_recv)
      ...
      if Ether in pkt:
         if pkt[Ether].src != get_if_hwaddr(iface):
            if pkt[Ether].type == TYPE_IPV4:
               ...
               global num_recirc_pkts_recv
               num_recirc_pkts_recv += 1
